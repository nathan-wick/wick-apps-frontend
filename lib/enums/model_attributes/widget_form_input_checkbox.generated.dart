...
/// Attributes and their types for WickWidgetFormInputCheckbox.
enum WickEnumModelAttributeWidgetFormInputCheckbox implements WickEnumModelAttributeBase {
  input(WickModelFormInputCheckbox),
  onChanged(Function);

  const WickEnumModelAttributeWidgetFormInputCheckbox(this.attributeType);
